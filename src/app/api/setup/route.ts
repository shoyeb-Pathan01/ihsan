...
export async function POST() {
  try {
    ...
    stmts.push({ sql: `CREATE TABLE "Profile" ("id" TEXT PRIMARY KEY, "name" TEXT NOT NULL DEFAULT 'Mr. Khan', "mission_start" TEXT NOT NULL DEFAULT '2026-08-23', "mission_end" TEXT NOT NULL DEFAULT '2027-01-01', "theme" TEXT NOT NULL DEFAULT 'dark', "schedule" TEXT, "baseline_azure" INTEGER, "baseline_arabic" INTEGER, "baseline_comm" INTEGER, "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)` });
    ...
    stmts.push({ sql: `CREATE TABLE "ArabicRevision" ("id" TEXT PRIMARY KEY, "lecture_id" TEXT NOT NULL, "date" TEXT NOT NULL, "understanding" INTEGER NOT NULL, "confidence" INTEGER NOT NULL, "struggles" TEXT, "next_revision_date" TEXT, "interval_level" INTEGER NOT NULL DEFAULT 1, "last_recall_result" TEXT, "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)` });
    ...
    stmts.push({ sql: `INSERT INTO "Profile" ("id","name","mission_start","mission_end","schedule") VALUES (?,?,?,?,?)`, args: ["default", "Mr. Khan", "2026-08-23", "2027-01-01", defaultSchedule] });
